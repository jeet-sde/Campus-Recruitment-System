...
<body data-sidebar="dark">
						...
						<div class="card">
							<div class="card-body">
								...
								<table id="datatable"
									...
									<tbody>
										<c:forEach items="${companyList}" var="i" varStatus="j">
											<tr>
												<td>${j.count}</td>
												<td>${i.name}</td>
												<td>${i.address}</td>
												...
												<td><a class="btn-outline-primary"
													...
													class="delete-icon-color" href="deleteCompany?id=${i.id}">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="myInfoModalLabel">Add company</h5>
	...
	<div id="myModal" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<f:form id="myForm" action="saveCompany" method="post"
					modelAttribute="companyVO">
					<div class="modal-header">
