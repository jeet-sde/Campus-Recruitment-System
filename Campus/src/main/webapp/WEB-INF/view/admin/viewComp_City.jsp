...
<body data-sidebar="dark">
						...
						<div class="card">
							<div class="card-body">
								...
								<table id="datatable"
									...
									<tbody>
										<c:forEach items="${Comp_CityList}" var="i" varStatus="j">
											<tr>
												<td>${j.count}</td>
												<td>${i.Comp_StateVO.stateName}</td>
												<td>${i.cityName}</td>
	...
	<div id="myModal" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<f:form id="myForm" action="saveComp_City" method="post"
					modelAttribute="Comp_CityVO">
					<div class="modal-header">
					...
					<div class="modal-body">
						<div class="mb-3">
							...
							<f:select path="Comp_StateVO.id" class="form-control" id="stateName">
								<option value="" disabled selected>Select a state</option>
								<c:forEach items="${Comp_StateList}" var="i">
